        ...
        <div style={{ background: 'white', borderRadius: 16, padding: 28, boxShadow: '0 1px 4px rgba(0,0,0,0.08)' }}>
          ...
          {etape === 1 && (
            <div>
              ...
              <button onClick={() => { if (!form.bailleur_prenom || !form.bailleur_nom || !form.locataire_prenom || !form.locataire_nom || !form.locataire_email) { alert('Champs obligatoires manquants.'); return } setEtape(2) }}
