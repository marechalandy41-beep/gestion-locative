          ...
          {etape === 4 && (
            <div>
              ...
              <div style={{ display: 'flex', gap: 10 }}>
                ...
                <button onClick={finaliserEtSauvegarder} disabled={loading} style={{ flex: 2, background: loading ? '#86efac' : '#16a34a', color: 'white', padding: 12, borderRadius: 10, border: 'none', cursor: loading ? 'not-allowed' : 'pointer', fontWeight: 700, fontSize: 15 }}>
