...
async function envoyerVersYousign() {
  ...
  async function envoyerPourSignatureLocataire() {
    ...
    try {
      ...
      const bailData = {
        user_id: user.id, bien_id: parseInt(form.bien_id), type_bail: 'Étudiant',
        loyer_hc: parseFloat(form.loyer_hc), charges: parseFloat(form.charges) || 0,
        ...
        bailleur_naissance: form.bailleur_naissance || null, bailleur_lieu_naissance: form.bailleur_lieu_naissance, bailleur_nationalite: form.bailleur_nationalite,
        ...
        locataire_type: 'particulier', locataire_prenom: form.locataire_prenom, locataire_nom: form.locataire_nom,
        locataire_email: form.locataire_email, locataire_telephone: form.locataire_telephone,
        locataire_naissance: form.locataire_naissance || null, locataire_nationalite: form.locataire_nationalite,
        locataire_profession: form.etablissement, locataire_adresse: form.locataire_adresse,
        surface_habitable: parseFloat(form.surface_habitable) || null, nombre_pieces: parseInt(form.nombre_pieces) || null,
        etage: form.etage, equipements: form.equipements, classe_dpe: form.classe_dpe, numero_lot: form.numero_lot,
