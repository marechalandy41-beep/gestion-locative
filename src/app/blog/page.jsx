    ...
    <main style={{ minHeight: '100vh', background: '#f9fafb' }}>
      ...
      <nav style={{ background: 'white', borderBottom: '1px solid #e5e7eb', position: 'sticky', top: 0, zIndex: 100 }}>
        <div style={{ maxWidth: 1200, margin: '0 auto', padding: '16px 24px', display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
          <a href={connecte ? '/dashboard' : '/'} style={{ display: 'flex', alignItems: 'center', gap: 8, fontSize: 20, fontWeight: 800, color: '#2563eb', textDecoration: 'none' }}>
          ...
          <div style={{ display: 'flex', gap: 12, alignItems: 'center' }}>
            ...
            <a href="/simulateur-rentabilite" style={{ color: '#2563eb', fontSize: 14, textDecoration: 'none', fontWeight: 600 }}>📊 Simulateur de rentabilité</a>
